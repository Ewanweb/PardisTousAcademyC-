...
namespace Pardis.Infrastructure.Migrations
{
    ...
    [Migration("20260206120804_FixPaymentAttemptRowVersion")]
    partial class FixPaymentAttemptRowVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pardis.Domain.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e4679165-b6a7-4e61-b77e-a7795f783f18",
                            CreatedAt = new DateTime(2024, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHrKGbI4HTxAd2uPGdWrLfF/Zl6TuPEuN+CYXRaFep361qMgF+NHUw85eSSv+mc8yQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0f1cfdb5-9e3a-44b9-a30b-d02ccfed4391",
                            CreatedAt = new DateTime(2024, 1, 1, 12, 0, 0, 0, DateTimeKind.Utc),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGkJ2KkzOFeUbFQSVoqYXYW7FD2/Y8zOSqBMorIKCJ9/A7X2TDhKs+IjvlpUn1BO7g==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("Pardis.Domain.Blog.PostSlugHistory", b =>
                {
                    b.HasOne("Pardis.Domain.Blog.Post", "Post")
            ...
            modelBuilder.Entity("Pardis.Domain.Blog.PostTag", b =>
                {
                    ...
                    b.HasOne("Pardis.Domain.Blog.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
